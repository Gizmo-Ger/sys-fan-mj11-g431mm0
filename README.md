...
- **[FanCalibration.md](FanCalibration.md)** — automated PWM/RPM sweep tool
  that maps fan-zone duty cycle to RPM per BMC, using an isolated calibration
  profile so it never touches the live fan curve.
